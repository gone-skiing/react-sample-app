...
const burgerBuilder = (state = initialState, action) => {
    switch (action.type) {
        case actionTypes.ADD_INGREDIENT: return addRemoveIngredient(state, action.ingredientName, 1);
        case actionTypes.REMOVE_INGREDIENT:return addRemoveIngredient(state, action.ingredientName, -1);
